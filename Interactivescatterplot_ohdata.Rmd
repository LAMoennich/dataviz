...
For question 1, I build an interactive scatter plot showing the relationship between the percentage of African American resident per county as compared with the percentage of persons in each county reporting that they are food insecure. The plot and code can be found below:
